...
curl -sL -o assets/index-vlhQ_Ovu.js "https://raw.githubusercontent.com/Arbor-Prime/Ghostpostu/main/dist/assets/index-vlhQ_Ovu.js"
...
echo "JS: $(wc -c < assets/index-vlhQ_Ovu.js) bytes"
