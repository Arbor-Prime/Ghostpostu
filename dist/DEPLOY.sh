...
curl -sL -o assets/index-ezohBiib.js "https://raw.githubusercontent.com/Arbor-Prime/Ghostpostu/main/dist/assets/index-ezohBiib.js"
...
echo "JS: $(wc -c < assets/index-ezohBiib.js) bytes"
echo "CSS: $(wc -c < assets/index-CpuizkpF.css) bytes"
echo "DONE — frontend only, no PM2 restart needed"
