...
curl -sL -o assets/index-_tU8GJX-.js "https://raw.githubusercontent.com/Arbor-Prime/Ghostpostu/main/dist/assets/index-_tU8GJX-.js"
...
echo "JS: $(wc -c < assets/index-_tU8GJX-.js) bytes"
