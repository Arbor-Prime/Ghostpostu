...
curl -sL -o assets/index-C69Cv18M.js "https://raw.githubusercontent.com/Arbor-Prime/Ghostpostu/main/dist/assets/index-C69Cv18M.js"
...
echo "JS: $(wc -c < assets/index-C69Cv18M.js) bytes"
