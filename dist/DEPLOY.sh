...
curl -sL -o assets/index-DNclL8LH.js "https://raw.githubusercontent.com/Arbor-Prime/Ghostpostu/main/dist/assets/index-DNclL8LH.js"
...
echo "JS: $(wc -c < assets/index-DNclL8LH.js) bytes"
